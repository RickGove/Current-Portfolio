...
// import { searchImagesByCity } from './SearchBar/';
	...
	async findWeatherInfo(latLon) {
		...
		axios
			...
			.then((response) => {
				...
				this.props.setInitialLocationData(response);
			})
			.catch((err) => {
...
const mapStateToProps = (state) => {
	return {
		...
		dataFromInitialLocationSearch: state.dataFromInitialLocationSearch,
	};
};
