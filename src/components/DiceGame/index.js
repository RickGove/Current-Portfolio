		...
		<DiceDiv>
			<div className="wrapper clearfix">
				...
				<div className="rules-wrapper">
					...
					<div className="rules-div" ref={rulesDivRef}>
						<h2>RULES:</h2>
						<ul>
							<li>The goal is to reach 40 points</li>
							<li>
								Click to roll the dice, the value will be added to current
								points
							</li>
							<li>If you roll a one, all current points are lost</li>
